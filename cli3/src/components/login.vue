    ...
    <div class="row">
        <div class="col-md-12 tal mt20">
            ...
            <input type="hidden" id="returnUrl" name="returnUrl" value="http://m.legendshop.cn/p/orderDetails"/>
              ...
              <input name="j_username" v-model="username" id="username" type="text" style="margin-bottom: -2px;-webkit-appearance:none; " class="form-control" placeholder="帐户名/手机号码" message="账号" required="true" autofocus=""  tabindex="1" >
              <br>
	          ...
	          <label class="checkbox">
                ...
                <div class="col-xs-5 p0" style="margin-left:10px;"><button type="button" class="btn btn-default btn-block" @click="zc"  tabindex="6" >注 册</button></div>
            </form>
        </div>
     </div>
	</div>
